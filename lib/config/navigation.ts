      ...
      items: [
        {
          ...
          description: 'Upload your FAA Knowledge Test results for instant ACS code extraction',
          href: '/upload'
        },
        {
          icon: 'Search' as const,
          title: 'ACS Search',
          description: 'Search through 10,257+ ACS codes from official FAA publications',
          href: '/acs'
        },
        {
