...
export const FEATURE_COMPARISON_DATA: FeatureCategory[] = [
  { 
    ...
    features: [
      { 
        ...
        description: "Map FAA test questions to specific ACS areas for targeted study", 
        free: "3/day", 
        pro: "Unlimited", 
        cfi: "Unlimited", 
        school: "Unlimited" 
      ...
      { 
        ...
        description: "Calculate crosswind components for runway planning and training", 
        free: "5/day", 
        pro: "Unlimited", 
        cfi: "Unlimited", 
        school: "Unlimited" 
      ...
      { 
        name: "Weight & Balance", 
        description: "Compute aircraft weight, CG, and loading for different configurations", 
        free: "3/day", 
        pro: "Unlimited", 
        cfi: "Unlimited", 
        school: "Unlimited" 
      ...
      { 
        ...
        description: "Track night, passenger, and instrument currency requirements automatically", 
        free: false, 
        pro: true, 
        cfi: true, 
        school: true 
      ...
      { 
        ...
        description: "Verify eligibility requirements and totals reconciliation for certificates and ratings", 
        free: false, 
        pro: true, 
        cfi: true, 
        school: true 
  ...
  { 
    ...
    features: [
      { 
        name: "Practice Tests", 
        description: "FAA-style practice exams with detailed explanations and ACS references", 
        free: "Preview only", 
        pro: "Full access", 
        cfi: "Full access", 
        school: "Full access" 
      ...
      { 
        name: "SRS Flashcards", 
        description: "Spaced repetition system flashcards that adapt to your learning progress", 
        free: false, 
        pro: true, 
        cfi: true, 
        school: true 
      ...
      { 
        name: "CFI-AI Tutor", 
        description: "AI-powered tutor with official ACS citations and personalized explanations", 
        free: false, 
        pro: true, 
        cfi: true, 
        school: true 
      ...
      { 
        name: "Study Plans", 
        description: "Personalized study plans based on your test results and weak areas", 
        free: "Preview only", 
        pro: "Customizable", 
        cfi: "Customizable", 
        school: "Customizable" 
  ...
  { 
    ...
    features: [
      { 
        ...
        description: "Organize student folders with progress tracking and readiness scores", 
        free: false, 
        pro: false, 
        cfi: true, 
        school: true 
      ...
      { 
        ...
        description: "Complete FAR 61.x endorsement library with customizable templates", 
        free: false, 
        pro: false, 
        cfi: true, 
        school: true 
      ...
      { 
        name: "Lesson Builder", 
        description: "Create weather-backup lesson plans and structured training curricula", 
        free: false, 
        pro: false, 
        cfi: true, 
        school: true 
      ...
      { 
        ...
        description: "Monitor individual student progress with detailed analytics and insights", 
        free: false, 
        pro: false, 
        cfi: true, 
        school: true 
      ...
      { 
        ...
        description: "Comprehensive logbook audits with IACRA readiness verification", 
        free: false, 
        pro: false, 
        cfi: "3/month", 
        school: "10/month" 
  ...
  { 
    ...
    features: [
      { 
        ...
        description: "Number of instructor accounts included in your subscription", 
        free: false, 
        pro: false, 
        cfi: "1", 
        school: "10+" 
      ...
      { 
        ...
        description: "Track fleet-wide student progress and aggregate readiness metrics", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: true 
      ...
      { 
        name: "DPE Radar", 
        description: "Get alerts for DPE scheduling opportunities and examiner insights", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: true 
      ...
      { 
        ...
        description: "Monitor insurance requirements and regulatory compliance across your fleet", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: true 
      ...
      { 
        name: "API Access", 
        description: "Integrate with your existing school management systems via REST API", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: true 
      ...
      { 
        ...
        description: "Custom branding and domain for your school's personalized platform", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: "Add-on" 
  ...
  { 
    ...
    features: [
      ...
      { 
        name: "Phone Support", 
        description: "Direct phone access to our support team for urgent issues", 
        free: false, 
        pro: false, 
        cfi: true, 
        school: true 
      ...
      { 
        ...
        description: "Assigned customer success manager for personalized onboarding and support", 
        free: false, 
        pro: false, 
        cfi: false, 
        school: true 
