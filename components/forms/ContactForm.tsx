...
export function ContactForm({
  ...
  if (submitSuccess) {
    return (
      <div
        className={cn(
          "mx-auto max-w-md rounded-lg border border-green-200 bg-green-50 p-6",
          className
        )}
      >
    ...
    >
      <div>
        ...
        <Input
          ...
          disabled={isLoading}
          className={
            form.hasError("name") ? "border-red-300 focus:border-red-500" : ""
          }
        />
      ...
      <div>
        ...
        <select
          ...
          disabled={isLoading}
          className={cn(
            "w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-50 disabled:opacity-75",
      ...
      <div>
        ...
        <textarea
          ...
          disabled={isLoading}
          className={cn(
            "resize-vertical w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-50 disabled:opacity-75",
