...
describe("FeatureSpotlightMenu Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("renders all provided features", () => {
      ...
      mockFeatures.forEach((feature) => {
        expect(
          screen.getByRole("tab", { name: feature.label })
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Interaction", () => {
    it("calls onSelect when a feature is clicked", () => {
      ...
      render(
        <FeatureSpotlightMenu features={mockFeatures} onSelect={mockOnSelect} />
      );
  ...
  describe("Styling and CSS Classes", () => {
    ...
    it("shows/hides scroll indicators based on overflow state", async () => {
      ...
      const { rerender } = render(
        <FeatureSpotlightMenu features={mockFeatures} />
      );
  ...
  describe("Accessibility", () => {
    ...
    it("has proper aria-label on scroll buttons", async () => {
      ...
      await waitFor(() => {
        ...
        if (leftArrow)
          expect(leftArrow).toHaveAttribute("aria-label", "Scroll left");
        if (rightArrow)
          expect(rightArrow).toHaveAttribute("aria-label", "Scroll right");
      });
    });
