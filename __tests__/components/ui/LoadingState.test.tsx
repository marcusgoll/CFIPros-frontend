...
describe('SkeletonText', () => {
  ...
  it('should apply custom className', () => {
    const { container } = render(<SkeletonText className="custom-skeleton-text" />);
...
describe('SkeletonCard', () => {
  it('should render card skeleton without image by default', () => {
    ...
    expect(container.querySelector('[style*="height: 160px"]')).not.toBeInTheDocument();
  });

  it('should render card skeleton with image when showImage is true', () => {
    const { container } = render(<SkeletonCard showImage={true} />);
    
    expect(container.querySelector('[style*="height: 160px"]')).toBeInTheDocument();
  });
...
describe('withLoading', () => {
  ...
  it('should render error state when error is provided', () => {
    render(<WrappedComponent loading={false} error="Error occurred" message="Test message" />);
