...
describe("ContactForm", () => {
  ...
  it("should have proper form labels and placeholders", () => {
    ...
    expect(
      screen.getByPlaceholderText("Brief subject line")
    ).toBeInTheDocument();
    expect(
      screen.getByPlaceholderText("Please describe your inquiry in detail...")
    ).toBeInTheDocument();
  });
  ...
  it("should render category options", () => {
    ...
    expect(
      screen.getByRole("option", { name: /billing question/i })
    ).toBeInTheDocument();
    expect(
  ...
  it("should include privacy notice", () => {
    ...
    expect(
      screen.getByText(/never share your information/i)
    ).toBeInTheDocument();
  });
});
