...
describe('Application Constants', () => {
  ...
  describe('Validation rules', () => {
    it('should have valid validation rules', () => {
      ...
      expect(typeof VALIDATION_RULES.PASSWORD.REQUIRE_UPPERCASE).toBe('boolean');
      expect(typeof VALIDATION_RULES.PASSWORD.REQUIRE_LOWERCASE).toBe('boolean');
      ...
      expect(VALIDATION_RULES.NAME.MAX_LENGTH).toBeGreaterThan(VALIDATION_RULES.NAME.MIN_LENGTH);
    });
  });
